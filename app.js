...
// Click event to add a Post to the db
...
// Click event to mark a Post as read
...
// Click event to mark a Post as not read
...
// Load unread posts and render them to the screen
function getUnread() {
  $("#unread").empty();
...
// Load read posts and render them to the screen
function getRead() {
  $("#read").empty();
